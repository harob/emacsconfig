(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (yasnippet yaml-mode web-mode twilight-theme twilight-anti-bright-theme tree-mode surround smex smartparens scss-mode rust-mode ruby-electric request rainbow-identifiers rainbow-delimiters protobuf-mode projectile pcre2el paradox org noflet neotree mustache-mode mo-git-blame midje-mode markdown-mode magit lua-mode less-css-mode ido-vertical-mode ido-ubiquitous haskell-mode goto-last-change go-mode git-gutter-fringe+ framemove flycheck flx-ido fiplr fill-column-indicator exec-path-from-shell evil-visualstar evil-nerd-commenter evil-matchit evil-leader evil-anzu ess epresent elscreen elisp-slime-nav dired-details+ diminish deft csv-mode column-marker color-theme-solarized color-theme-sanityinc-tomorrow color-identifiers-mode coffee-mode buffer-move browse-at-remote base16-theme ag ack-and-a-half ace-jump-buffer ac-nrepl)))
